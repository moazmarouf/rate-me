...
@section('content')
    <div class="row" style="margin-bottom:20px;">
        <div class="col-xs-6">
            <button class="btn bg-teal-400 btn-block btn-float btn-float-lg" type="button"><i class="icon-list-numbered"></i> <span>الرسايل : {{App\Models\Message::where('type',1)->count()}} </span> </button>
        </div>
    </div>
